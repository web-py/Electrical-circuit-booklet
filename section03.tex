\chapter{روش‌های تحلیل مدار}

\section{روش تحلیل گره}
...
\section{مدارهای هم ارز تونن و نورتن}
...
\subsection*{ولتاژ مدار باز(ولتاژ تونن)}
...
\subsection*{جریان اتصال کوتاه(جریان نورتن)}
