...
\subsection*{جمع و تفریق اعداد مختلط}
\begin{center}
	\begin{minipage}{0.4\textwidth}
		\begin{gather*}
...
\section*{نمایش در فرم فاز برداری}
جریان‌ها و ولتاژهای 
$cos$
...
\begin{solu}
	\ \\
	\begin{gather*}
		Z_{eq} = 2 || j4 = \frac{2(j4)}{2+j4} = \frac{8j}{4.47\measuredangle \tan^{-1}(2)}\\
