...
\subsubsection{قانون مداری جریان(KCL)}
...
\subsubsection{قانون مداری ولتاژ(KVL)}
...
\subsection{تحلیل مدار تک حلقه‌ای}
...
\subsubsection*{آرایش سری(متوالی)}
...
\subsubsection*{آرایش ستاره-مثلث}
...
\vspace{1cm}
\subsubsection*{مدار تقسیم ولتاژ}
...
\subsubsection*{مدار تقسیم جریان}
